...
4. Caso optar por outro nome no banco de dados no phpmyadmin, é necessário alterar o nome do mesmo na variavel $db_nome-> arquivo conexao.php, na pasta Arquivos PHP.

    ...
    <!-- DIVISÃO CONTAINER -->
        <div class="container_body">
            <div class="container_son">
                <div>
                    <a href="Criar_Paciente.php"><img src="../imagens/cadastrarpaciente.jpeg" style: width="150px" height="150px";></img></a><BR><br>
                    <p>Cadastrar paciente</p><br>
                </div>
                <div stlye: align-intens="center";>
                    <a href="listagem_usuarios.php"><img src="../imagens/usuarios.jpeg" style: width="150px" height="150px";></img></a><BR><br>
                    <p>Usuários</p><br>
                </div>
            </div>
            ...
            <div class="container_son">
                <div>
                    <a href="listagem_medicos.php"><img src="../imagens/medico.jpeg" style: width="150px" height="150px";></img></a><BR><br>
                    <p>Médicos</p><br>
                </div>
                <div stlye: align-intens="center";>
                    <a href="listagem_convenios.php"><img src="../imagens/convenio.jpeg" style: width="150px" height="150px";></img></a><BR><br>
                    <p>Convênio</p><br>
                </div>
            </div>
            <div class="container_son">
